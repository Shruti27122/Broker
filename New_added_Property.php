...
<nav class="navbar navbar-inverse" style="padding:10px; font-size: large;">
  ...
  <thead>
    <tr>
      ...
      <th scope="col">Property Plans</th>
  ...
  <tbody>
    ...
    require 'vendor/autoload.php';
        ...
        foreach ($res as $key => $res1) {
            ...
            <tr>
                <td>'.$i++.'</td>
                <td><img src="Images/'.$res1['filename'].'" class="card-img-top"
                style="width:250px;height: 200px;"></td>
                <td><a href="delete_image.php?id='.$res1['_id'].'" class="btn btn-danger">Delete</a></td>

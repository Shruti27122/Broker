...
<div class="container">
  <h2 style="  margin-left:490px;"><span class="glyphicon glyphicon-user"></span> &nbsp;Register</h2>
  <h3 style="  margin-left:490px;">Create an account</h3>
  <form action="insert.php" method="POST">
    <div class="form-group">
      <label for="email">Enter Username:</label>
      <input type="text" class="form-control" id="email" required="" placeholder="Enter Username" name="email" style="width: 400px; border: 1px solid #16161d;">
    </div>
    <div class="form-group">
      <label for="pwd">Enter Password:</label>
      <input type="password" class="form-control" required=" " id="pwd" placeholder="Enter password" name="pwd" style="width: 400px; border:1px solid #16161d;">
    </div>
    <div class="form-group">
        <label for="pwd">Confirm Password:</label>
        <input type="password" class="form-control" required=" " id="pwd" placeholder="Confirm Password" name="cfpwd" style="width: 400px; border:1px solid #16161d;">
      </div>
      <div class="form-group">
        <label for="pwd">First Name:</label>
        <input type="text" class="form-control" id="pwd" required=" " placeholder="First Name" name="fname" style="width: 400px; border:1px solid #16161d;">
      </div>
      <div class="form-group">
        <label for="pwd">Last Name:</label>
        <input type="text" class="form-control" id="pwd" required=" " placeholder="Last Name" name="lname" style="width: 400px; border:1px solid #16161d;">
      </div>
      
    <button onclick="alert('User Register Successfully...')" type="submit" class="btn btn-primary">Submit</button>
  </form>
</div>

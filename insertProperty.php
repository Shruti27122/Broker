<?php
 ...
 $client = new MongoDB\Client;
    ...
    if(isset($_POST['submit'])){
        ...
        $document = array( 
            'Property_Type' => $_POST['protype'],
            'Flat_Details' => $_POST['flatde'],
            'Preferred_Tenant' => $_POST['tenant'],
            'Parking' => $_POST['parking']
        );
     
        $Property->insertOne($document);
...
<nav class="navbar navbar-inverse" style="padding:10px; font-size: large;">
  ...
  <h3 style="  margin-left:490px;">Insert New Property</h3>
        ...
        <div class="form-group">
          ...
          <input type="text" class="form-control" required=" " id="pwd"   name="protype" style="width: 400px; border:1px solid #16161d;">
        </div>
        <div class="form-group">
            <label for="pwd">Flat Details:</label>
            <input type="text" class="form-control"  required=" " id="pwd"  name="flatde" style="width: 400px; border:1px solid #16161d;">
          </div>
          <div class="form-group">
            <label for="pwd">Preferred Tenant:</label>
            <input type="text" class="form-control"  id="pwd" required=" "  name="tenant" style="width: 400px; border:1px solid #16161d;">
          </div>
          <div class="form-group">
            <label for="pwd">Parking:</label>
            <input type="text" class="form-control"  id="pwd" required=" "  name="parking" style="width: 400px; border:1px solid #16161d;">
          </div>
